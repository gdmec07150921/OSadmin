...
<div class="block">
    ...
    <table class="table table-striped" >
            ...
            <tbody>
            <{foreach name=question from=$questions item=question}>
                <tr>
                ...
                <td><a href="question_modify.php?question_no=<{$question.question_no}>" title= "回复" ><i class="icon-pencil"></i></a>
                &nbsp;
                <a data-toggle="modal" href="#myModal"  title= "删除" ><i class="icon-remove" href="question.php?method=del&question_no=<{$question.question_no}>#myModal" data-toggle="modal" ></i></a>
                </td>
                </tr>
            <{/foreach}>
          </tbody>
