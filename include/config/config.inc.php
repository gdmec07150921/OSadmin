...
// OSAdmin 常量
define('ADMIN_URL' ,'http://10.10.13.46/osadmin');
//define('ADMIN_URL' ,'http://10.10.13.197/osadmin');
//define('ADMIN_URL' ,'http://192.168.199.122');
    
define('ADMIN_TITLE' ,'管理后台');
define('COMPANY_NAME' ,'OSAdmin.org');
//define('IMG_URL' ,'http://172.19.145.48/osadmin/img/');
  //define('IMG_URL' ,'http://10.10.13.197/osadmin/img/');
define('IMG_URL' ,'http://10.10.13.46/img/');
// OSAdmin 数据库设置
...
// 课程数据库设置
define('COURSE_DB_ID' ,'course');
$DATABASE_LIST[COURSE_DB_ID] = array (
	'server' => '127.0.0.1',
	'port' => '3306',
	'username' => 'root',
	'password' => '',
